...
namespace UntitledSandbox.Terrain.Renderers
{
	public class AxisRenderer : Renderer
	{
		...
		public override void Load()
		{
			...
			this.Axes[0] = new VertexPositionColor(new Vector3(0, 0, 0), Color.White);
			this.Axes[1] = new VertexPositionColor(new Vector3(1000, 0, 0), Color.White);
		...
		{
			this.AxisEffect.View = this.Player.Camera.ViewMatrix;
			this.AxisEffect.Projection = this.Player.Camera.ProjectionMatrix;
